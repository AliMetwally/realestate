...
class Model_search_Property extends CI_Model
{
    ...
    public function make_query()
    {
         ...
         */
        // because datatable send meta-data with post data we will limit the post data to the parametes needed only
        $data = $this->input->post(
                array('property_type', 'tower_id', 'key_number', 'state_id', 'area_id',
                    'area', 'min_price', 'max_price', 'finishing', 'min_floor', 'max_floor')
                );
