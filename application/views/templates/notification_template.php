                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url('manager')?>">
                                <i class="fa fa-backward"></i> <span>الرجوع للرئيسية</span>                               
                            </a>
                        </li>                        
                        <!-- home page -->
                        <li>
                            <a href="<?php echo base_url('notifications')?>">
                                <i class="fa fa-bell"></i> <span>عرض التنبيهات</span>                               
                            </a>
                        </li>                        
                        
                        <!-- enter notifications -->
                        <li>
                            <a href="<?php echo base_url('notifications/notification')?>">
                                <i class="fa fa-bell-slash"></i> <span>إدخال التنبيهات</span>                               
                            </a>
                        </li>                        
                    </ul>
                </section>
